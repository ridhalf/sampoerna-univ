            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('articles.update',$article->id)}}" id="form-article" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6 col-lg-6">
                                        <div class="form-group">
                                            <label for="title">Title <span class="text-danger">*</span></label>
                                            <textarea class="form-control" id="title" name="title" rows="5">{{ $article->title }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            >
                                                ...
                                                <option value="article" @if($article->category == "article") selected @endif>Article</option>
                                            </select>
...
@push('script')
    ...
    <script>
        ...
        const existingImageUrl = "{{ asset('storage/'.$article->image) }}";
        if (existingImageUrl) {
