                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <div class="card-title text-align-center">Add User</div>
                        </div>
                        </div>
                        <div class="card-body">
                            <form action="{{route('users.store')}}" id="form-user" method="POST">
                                @csrf
                                <div class="row">
...
@push('script')
    <script>
        ...
        function resetError(is_success = false) {
            const errorFields = ["Name", "Email", "Password", "Status","Role"];
